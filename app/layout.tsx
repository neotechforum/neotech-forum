...
export const metadata: Metadata = {
  ...
  description:
    "Forum premium B2B réunissant 150 décideurs autour de l'IA, la blockchain et la transformation digitale. Hôtel Président Wilson, Genève, 19 septembre 2026. Organisé par EagleChain SA.",
  keywords: [
    'NeoTech Forum', 'forum IA Genève', 'forum blockchain Suisse', 'EagleChain SA',
    'intelligence artificielle entreprise', 'blockchain réglementation', 'DeFi Europe',
    'événement tech Genève 2026', 'forum décideurs Suisse', 'transformation digitale',
    'Hôtel Président Wilson Genève', 'forum B2B Genève', 'NeoTech Forum 2026',
  ],
  ...
  openGraph: {
    ...
    description: "Forum premium B2B — 150 décideurs, Hôtel Président Wilson, Genève, 19 septembre 2026. IA, Blockchain, Transformation Digitale. Par EagleChain SA.",
    images: [{ url: '/logo.png', width: 1200, height: 630, alt: 'NeoTech Forum Genève 2026' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'NeoTech Forum · Genève 2026',
    description: "150 décideurs. IA, Blockchain, Transformation Digitale. Hôtel Président Wilson, 19 septembre 2026.",
    images: ['/logo.png'],
